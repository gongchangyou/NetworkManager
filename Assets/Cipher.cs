...
public class Cipher {
	...
	public static string DEFAULT_IV_128_REQ;
	public static string DEFAULT_IV_128_RES;
	public static string DEFAULT_IV_128_CHAT;
	...
	static Cipher() {
		...
		DEFAULT_IV_128_REQ = "pY\"[76x<ZJgbjcne";
		DEFAULT_IV_128_RES = "^/0iersblY@8khnS";
		DEFAULT_IV_128_CHAT = "#;tki0KT5,TIvSTv";
#elif !UNITY_EDITOR
		System.IntPtr dkPtr;
		System.IntPtr diReqPtr;
		System.IntPtr diResPtr;
		System.IntPtr diChatPtr;
#if UNITY_ANDROID
		dkPtr = AndroidMisc.GetDK();
		diReqPtr = AndroidMisc.GetReqDI();
		diResPtr = AndroidMisc.GetResDI();
		diChatPtr = AndroidMisc.GetChatDI();
#elif UNITY_IPHONE
		dkPtr = IOSMisc.GetDK();
		diReqPtr = IOSMisc.GetReqDI();
		diResPtr = IOSMisc.GetResDI();
		diChatPtr = IOSMisc.GetChatDI();
#endif
		DEFAULT_NETWORKHASH = System.Runtime.InteropServices.Marshal.PtrToStringAuto(dkPtr);
		DEFAULT_IV_128_REQ = System.Runtime.InteropServices.Marshal.PtrToStringAuto(diReqPtr);
		DEFAULT_IV_128_RES = System.Runtime.InteropServices.Marshal.PtrToStringAuto(diResPtr);
		DEFAULT_IV_128_CHAT = System.Runtime.InteropServices.Marshal.PtrToStringAuto(diChatPtr);
#endif
	}
